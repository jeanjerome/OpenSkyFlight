...
import { BufferGeometry, Material, Mesh, MeshBasicNodeMaterial, Texture } from "three";
...
export class TileLoader implements ITileLoader {
	...
	/** Error material */
	private readonly _errorMaterial = new MeshBasicNodeMaterial({
		color: 0xff0000,
		transparent: true,
		opacity: 0,
		name: "error-material",
	...
	/** Background material */
	public readonly backgroundMaterial = new MeshBasicNodeMaterial({ color: 0x112233 });
